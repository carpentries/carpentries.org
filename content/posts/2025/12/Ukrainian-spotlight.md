---
layout: page
authors: ["Angelique Trusler","Olexandr Konovalov"]
teaser: "For Ukraine, building an active Carpentries subcommunity means more than just learning foundational data and coding skills."
...
The Ukrainian Carpentries is a subcommunity within The Carpentries, focusing on supporting learners and Instructors by translating teaching materials into Ukrainian. The subcommunity is made up of Ukrainian researchers at different institutions in Ukraine and across the globe. It was initiated in 2022 after the start of the full-scale Russian invasion in Ukraine in order to help Ukrainian researchers who need to collaborate remotely because of being either internally displaced within Ukraine or refugees abroad. 

By increasing access to foundational coding and data skills, the community enables Ukrainian researchers and learners to participate more fully in open, collaborative science. 
Such training in open science practices contributes to the implementation of the [Ukrainian Open Science plan](https://www.opengovpartnership.org/members/ukraine/commitments/UA0090/), adopted in October 2022.
But for Ukraine, building an active Carpentries subcommunity means more than just learning foundational data and coding skills.  In the current context of the Russo-Ukrainian war, it also means the ability to share data and analysis about the impact of Russia’s aggression on Ukrainian society, economics, education, ecology, etc.  By working on GitHub, researchers could preserve this data and keep it accessible in case institutional data storage facilities suffer power outages or damage from Russian military attacks.  
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/H6_hg-PNlSs?si=DUXMQjVro3JJ6jx8" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
