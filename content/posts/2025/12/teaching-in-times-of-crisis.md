...
date: 2025-12-10  
time: "18:00:00"  
tags: ["CarpentryCon", "Community", "Feedback"]  
---
...
The group discussed "critical hope," which combines optimism with a critical examination of current circumstances and a commitment to improvement. This form of hope is not about blind positivity but about recognising difficulties and working collectively to overcome them. Instructors play a key role in modeling this mindset, encouraging students to persist and adapt in the face of adversity.  
...
1. **Set and Communicate Clear Boundaries**: Establishing explicit boundaries between professional and personal responsibilities helps manage conflicting demands. Regularly revisit and adjust these boundaries as needed.

2. **Foster Trust through Transparency**: Clearly communicate expectations, policies, and support structures. Ensure students know where to seek help and what to expect in terms of instructor availability and response times. 

3. **Model Critical Hope**: Encourage a balanced perspective that acknowledges challenges while focusing on collective action and achievable goals. Demonstrate resilience and adaptability, inspiring students to do the same.

4. **Prioritise Self-Care**: Recognise the importance of self-care for both educators and students. Encourage open discussions about well-being and provide resources for managing stress and maintaining mental health. 

5. **Leverage Institutional Support**: Utilise available resources such as IT support, libraries, and accessibility services. A cohesive support system can enhance the learning experience and alleviate some of the pressures on instructors. Relying on one another is a strength.
...
1. Crises can lead to conflict, especially when there are big differences between our own behaviours, wants, and needs as instructors and our employers' policies. This conflict adds an additional layer of discomfort to an already unstable situation. 
