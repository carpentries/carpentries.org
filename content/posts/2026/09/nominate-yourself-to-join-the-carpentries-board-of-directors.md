...
Nominate yourself for a community-elected position using [The Carpentries Board of Directors: Community-Elected Positions  form](https://docs.google.com/forms/d/e/1FAIpQLSd5qO1xXp38GMdCUCgFQREIBpxIjuGKwMweaRTAASyHfZamMg/viewform?usp=header). Your answers will be used in a blog post announcing the candidates for the community election. You can read previous [Election Nominee statements](/blog/2023/11/election-nominees-for-the-2024-board-of-directors/) for inspiration.  

## What expertise are we looking for?

As The Carpentries continues to evolve, we are looking to strengthen the Board with a diverse range of experiences, perspectives, and expertise. In particular, we are interested in candidates with knowledge or experience in one or more of the following areas:

* **Innovation, technology, and organisational change**, including artificial intelligence, new product development, evolving programs and services, and organisational restructuring.  
* **Financial sustainability and resource development**, including revenue generation, alternative revenue models, grant writing, fund development, and fundraising.  
...
* Any individual who has contributed to The Carpentries through participation on a Committee or Task Force, serving as a mentor or Maintainer, or otherwise making a significant contribution to any Lesson Program or The Carpentries in the past year, and thus is considered active in the community.
...
* October 16: Deadline for candidates to submit statements   
* October 19: Confirmation emails sent for voting status   
* October 23: Blog posts from candidates for community-elected positions are available to the community  
