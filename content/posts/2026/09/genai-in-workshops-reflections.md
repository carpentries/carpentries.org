---  
layout: page  
authors: ["Cecilia Baldoni", "Sabrina Brown"]  
teaser: "Two participants in the GenAI in Workshops series reflect on their experience"  
title: "Exploring GenAI with The Carpentries"  
date: 2026-09-17  
time: "09:00:00"  
...
We found that our answer remained the same before and after the workshop: *"It depends"*.
...
Our discussion revealed that different institutional tool subscriptions, previous user history, and prompting differences resulted in entirely different outputs, even if the question and the tool were the same.
This highlights one of many potential challenges instructors will face when using GenAI in teaching.
...
Many folks also noted that their primary driver for attending the bonus module was a sense of responsibility to address these gaps so that they could better support their learner communities and ensure their lessons remained relevant and impactful for learners.

## What we hope is next 

This workshop created a great environment for engaging community discussion to occur, so we hope The Carpentries continues to build on this momentum.
Experimenting with GenAI is the first step to reasoning whether or not their application is appropriate for full integration with The Carpentries curriculum or standard Instructor Training.
Defining the fundamental programming skills that are essential to The Carpentries way of learning will illuminate areas where AI can enhance existing lessons and support Instructors, but it will also flush out areas where AI use may be detrimental to a learner’s skill development.
Throughout this process, we encourage The Carpentries to continue to call on the community for input.
