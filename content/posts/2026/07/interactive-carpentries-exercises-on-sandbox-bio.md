...
Sandbox.bio is a free bioinformatics training platform, where all the tools you need run in the browser, so no setup is needed. This week at Sandbox.bio, we are releasing [**Programming with Python Exercises**](https://sandbox.bio/tutorials/carpentries-python-inflammation), an interactive companion to the exercises in The Carpentries' [Programming with Python](https://swcarpentry.github.io/python-novice-inflammation/) workshop.
...
![Debugging exercise animation](/blog/2026/07/sandbox-bio.gif)
...
## Thank You
Thank you to Danielle Sieh and SherAaron Hurt at The Carpentries for supporting us with testing, and for the work you all do making research computing more accessible to everyone.
