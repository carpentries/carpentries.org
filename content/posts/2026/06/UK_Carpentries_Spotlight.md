...
Olexandr Konovalov, a UK-based instructor, led a project to translate the Python Carpentries lesson into Ukrainian, achieving 100% translation of the lesson. Originally, plans were to translate the shell, Git, and GAP lessons using the Transifex platform — following a similar infrastructure previously used for Spanish translations. However, since 2024, the translation infrastructure has been migrated to [Crowdin](https://carpentries.org/blog/2024/05/software-carpentries-translation-efforts-in-ukrainian), and various lessons across our core curriculum are being translated. Olexandr Konovalov also ran 6 pilot training events in Ukrainian for Git during 2023-2025 and ran the first full [2-day online workshop in Ukraine](https://olexandr-konovalov.github.io/posts/2026/02/24/resilient-carpentries) in January 2026 - making Ukraine the 72nd country in the world hosting The Carpentries workshops.
...
Jannetta Steyn (with Colin Sauze) has been leading work on [CarpentriesOffline](https://carpentriesoffline.org/) and miniHPC — tools for running Carpentries workshops in environments without reliable internet — and has been running regular working meetings and skill-up sessions to create workshop websites.
