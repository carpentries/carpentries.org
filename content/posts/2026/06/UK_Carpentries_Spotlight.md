...
The UK Carpentries community gathers people involved in teaching skills for computational research, including Carpentry instructors, helpers or workshop coordinators.
...
## Mission and Vision of Subcommunity
...
The community held its inaugural meeting in February 2021 led by the [UK Software Sustainability Institute’s (SSI)](https://www.software.ac.uk/) research software training lead Aleks Nenadic, bringing together over 30 UK Carpentries instructors, helpers, helpers, and workshop coordinators from across the UK. The community was established as a space for UK Carpentry instructors, helpers and workshop coordinators to get to know each other, encourage collaboration, get questions answered, and help with organising workshops and finding instructors and helpers. However, the community gathers all people involved in teaching skills for computational research in general, and not just from the UK. 

## Regular Activities

Meetings are typically held on the 4th Monday of each month, 16:00–17:00 UK time, via Zoom. Upcoming meetings and previous meeting minutes can be found in the UK community’s [HackMD space](https://hackmd.io/V3ReKkEESzqyCNxWJdulOw#2026).
...
- a slot for Carpentries instructor training checkout (allowing new instructors to fulfil their community discussion requirement)

## Key Topics and Themes Over the Years

### Workshop Delivery and Pedagogy

Members have shared experiences running Software Carpentry, Data Carpentry, and Library Carpentry workshops across UK institutions. In late 2022, STFC's Patrick Austin presented on teaching a large-scale hybrid "Intermediate Research Software Development in Python" course involving 20 in-person and 21 online attendees, spread across 5 weeks, with 6 instructors and 12 helpers — sharing hard-won lessons about hybrid delivery challenges. 
...
Olexandr Konovalov, UK-based instructor, led a project to translate the Python Carpentries lesson into Ukrainian, achieving 100% translation of the Python lesson, originally with plans to translate shell, Git, and GAP lessons using the Transifex platform — following a similar infrastructure previously used for Spanish translations. However, since 2024, the translation infrastructure has been migrated to [CrowdIn](https://carpentries.org/blog/2024/05/software-carpentries-translation-efforts-in-ukrainian) and various lessons across our core curriculum are in the process of being translated. Olexandr Konovalov also ran 6 pilot training events in Ukrainian for Git during 2023-2025 and ran the first full [2-day online workshop in Ukraine](https://olexandr-konovalov.github.io/posts/2026/02/24/resilient-carpentries) in January 2026 - making Ukraine the 72nd country in the world hosting The Carpentries workshops.

### Lesson Infrastructure Transition

At CarpentryConnect Heidelberg 2024, Matthew Bluteau and Aleks Nenadic led a hack-day activity, which resulted in nine lessons being translated from the old Jekyll style lesson template to the new Carpentries Workbench lesson template, with the help of UK Carpentry community members.

### CarpentryConnect and Community Event

A CarpentryConnect event was previously hosted in Manchester in 2019, organised by Aleks Nenadic and others, with around 100 attendees covering teaching discussions, skill-up sessions, lightning talks, and breakouts. The community participated in CarpentryConnect Heidelberg in November 2024, hosted at the European Molecular Biology Centre. Apart from CarpentryConnect, the community has spearheaded a few community events as specialist training days at RSECon 2023 and 2025, both of which heavily featured The Carpentries. At Collaborations Workshop 2023, we organised a demo teaching session to encourage instructors back into teaching and in-person teaching.

### Collaborative Lesson Development Training

The Carpentries launched a collaborative lesson development training programme in late 2023, sitting alongside instructor training and focused on curriculum design, open-source collaboration, and GitHub-based good practice — receiving very strong early feedback. 

### CarpentriesOffline / miniHPC

Jannetta Steyn (with Colin Sauze) has been leading work on CarpentriesOffline and miniHPC — tools for running Carpentries workshops in environments without reliable internet — running regular working meetings and skill-up sessions for creating workshop websites.

### RSE Competencies and Skills Framework

The community has engaged with the RSE Competencies Toolkit and the DIRECT skills and competencies framework, with Phil Reed, Aman Goel, Aleks Nenadic and others from the UK Carpentry community working on defining technical, personal, and interpersonal skills for digital research technical professionals, including RSEs and research data managers and stewards In January 2026, the [DIRECT framework](https://directframework.com/) was discussed as a potential resource for comparing skills, supporting upskilling, and informing hiring and career pathways.

### Software Carpentry Curriculum Governance

In early 2026, community members including Aman Goel have been involved in the Software Carpentries Governance Committee, considering new courses for the curriculum such as ["Building Better Research Software"](https://github.com/carpentries-incubator/better-research-software), intermediate Python development, and ["Byte-sized RSE"](https://carpentries-incubator.github.io/byte-sized-rse-overview/) shorter teaching sessions, as well as reviewing and updating existing materials on Git.

### Infrastructure and Meeting Tools

In January 2026 the community discussed moving away from Zoom (which was the main meeting tool used by the community with the community Zoom room being owned by the University of Manchester, which are now discontinuing their licence) towards open-source alternatives such as Jitsi, with actions raised to evaluate options.
...
- UK Community workspace on HackMD: [hackmd.io/@local-uk](https://hackmd.io/@local-uk) 
- [The main document](https://hackmd.io/@local-uk/B132EYCe_) - the landing page containing pointers to other documents in the UK Community HackMD workspace
- Carpentries UK Community mailing list [local-uk](https://carpentries.topicbox.com/groups/local-uk) @Carpentries TopicBox
- Carpentries UK Community #local-uk channel under [Carpentries Slack](http://carpentries.slack.com)
- Community [GitHub Space](https://github.com/uk-carpentries)
