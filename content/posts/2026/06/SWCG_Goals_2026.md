...
get into scientific programming and managing their own data. However, a common question afterwards is what *workshop can we take
...
including planning, testing and releasing software and collaborative development.
...
We are very aware of the discussions of moving away from big corporate technology, such as the dependency on GitHub as a host for git repositories. There are [many good reasons](https://sfconservancy.org/GiveUpGitHub), including [digital
sovereignty for organisations](https://edri.org/our-work/europes-digital-sovereignty-starts-with-open-source), to use GitLab to host their own code repositories.

The SWC Governance Committee would be happy to support community members that would like develop a GitLab alternative to the [Version Control with Git](https://swcarpentry.github.io/git-novice/) lesson and publish it in the Incubator. We will review new lesson for consideration after finalising the process for new lesson/workshop adoption into SWC.

If you are interested in contributing towards a new lesson, please reach out to us at: [swc-governors@lists.carpentries.org](mailto:swc-governors@lists.carpentries.org)