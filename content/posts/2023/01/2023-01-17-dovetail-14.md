...
Since 2022-12-21, 
 ...
 - [{varnish} 0.2.11 -> 0.2.13](https://carpentries.github.io/varnish/news/index.html#varnish-0213)
   ...
   - The sidebar no longer takes up extra room at the foot of the document when
     collapsed. 
   <figure>
     <img src='/blog/2023/01/dovetail-table-before.png' alt='screen capture of a simple table with the first column awkwardly indented, text not differentiated from headings, and no indication of even or odd rows' width="42%" style='border: solid 1pt black;'/>
     <img src='/blog/2023/01/dovetail-table-after.png' alt='screen capture of a simple table with expected alignment, bold headings, and zebra striping that is much easier to look at' width="57%" style='border: solid 1pt black;'/>
     <figcaption>
...
![screenshot of the 'create a new fork' page with the "Copy the main branch only" checkbox highlighted in yellow](/blog/2023/01/dovetail-fork-create.png)
...
<figure>
  <img src='/blog/2023/01/dovetail-fork-pages-1.png' alt='screenshot of sidebar with the title "code and automation" with the last item, "pages", highlighted' width="30%" style='border: solid 1pt black;'/>
  <img src='/blog/2023/01/dovetail-pages-deploy.png' alt="screenshot of GitHub pages form that shows the source as 'Deploy from a branch', the branch as 'gh-pages', the folder as 'root'" width="69%" style='border: solid 1pt black;'/>
  <figcaption>
